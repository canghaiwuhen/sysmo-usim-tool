...
class Sysmo_isim_sja2(Sysmo_usim):
	...
	def __init__(self):
		#FIXME: We have different card models with different ATRs, make sure we can deal with that"
		#Sysmo_usim.__init__(self, "3B 9F 96 80 1F 87 80 31 E0 73 FE 21 1B 67 4A 4C 75 30 34 05 4B A9")
		Sysmo_usim.__init__(self, "3B 9F 96 80 1F 87 80 31 E0 73 FE 21 1B 67 4A 4C 75 31 33 02 51 B2")
	...
	def show_milenage_params(self):
		...
		isim_ef_milenage_cfg = SYSMO_ISIMSJA2_FILE_EF_MILENAGE_CFG(res.apdu)

		self.sim.card.SELECT_ADF_ISIM()
		self.sim.select(SYSMO_ISIMSJA2_EF_MILENAGE_CFG)
		res = self._read_binary(85)
		usim_ef_milenage_cfg = SYSMO_ISIMSJA2_FILE_EF_MILENAGE_CFG(res.apdu)

		print(" * Current Milenage Parameters in (ADF_USIM/EF.MILENAGE_CFG):")
		print(str(usim_ef_milenage_cfg))
		print(" * Current Milenage Parameters in (ADF_ISIM/EF.MILENAGE_CFG):")
		print(str(isim_ef_milenage_cfg))
		print("")
	...
	def dump(self):
		...
		#FIXME: Is there also an SQN file in the isim application
